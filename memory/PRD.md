...
- **Mentor names (June 2026, verified)**: Lokenndra Mewada (MD & Mentor), Taha Rahi (Director & Mentor — SEBI Registered Research Analyst, badge on his card), Pankaj Mehra (Director & Mentor). Photos/expertise still placeholders. Google Reviews placeholder block + MapSection removed from home page (MapSection retained on contact & SEO landing pages); home numbering re-sequenced to 01–07. Reveal/Stagger/StaggerItem now forward data-testid props.
- **Page restructure (June 2026, verified)**: Course Spotlights removed from home → now on /courses page ("A Closer Look At Each Program"). Mentor + Guest Lectures section removed from home → new dedicated /mentors page (SEO, breadcrumb, CTA); navbar "Mentor" link now routes to /mentors; sitemap updated; home section numbering re-sequenced (01–08). Hero badge text changed to "Best Stock Market Training in Bhopal" (user edit request).
